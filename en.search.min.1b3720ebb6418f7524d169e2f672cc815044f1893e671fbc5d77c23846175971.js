...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c1a0d892219847529ec5891f9f304cd89d955695d9692f8126aa8a6502e277c6.js',function(){input.required=false;search();});}
