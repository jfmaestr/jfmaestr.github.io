...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.00778141bdae8cd2cec72cfedcd3669d7ba11b679acdf9f500ed9657ba7d7565.js',function(){input.required=false;search();});}
