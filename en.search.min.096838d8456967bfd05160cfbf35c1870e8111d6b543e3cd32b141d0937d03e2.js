...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ebf8d0b99c87f7975ab11b5fdab44dccddfea9e14bffea0195cd6751700803bd.js',function(){input.required=false;search();});}
